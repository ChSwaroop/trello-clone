    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-1">
          <div className="min-w-0 flex-1 space-y-1.5 pl-0 transition-[padding-left] duration-200 ease-out group-hover/card:pl-5">
            {/* Labels */}
                ...
                {card.dueDate && (
                  <span
                    className={cn(
                      ...
                      overdue &&
                        !card.dueComplete &&
                        "bg-trello-danger text-white",
                      dueSoon &&
                        !overdue &&
                        !card.dueComplete &&
                        "bg-trello-warn text-trello-navy",
                      !overdue &&
                        !dueSoon &&
                        !card.dueComplete &&
